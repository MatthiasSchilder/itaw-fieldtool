...
namespace fieldtool
{
    public class FtTransmitterGpsDataPoint : FtTransmitterData
    {
        ...
        public FtTransmitterGpsDataPoint(string line)
        {
        ...
        {
            return new Coordinate(Rechtswert.Value, Hochwert.Value);
        }
    }
}
